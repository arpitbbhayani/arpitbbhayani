...
- [S4DB](https://github.com/arpitbbhayani/s4db) - A Python-based embedded KV DB built on top of S3.
...
- [Present-md](https://github.com/arpitbbhayani/present-md) - Write slides in Markdown, run locally, present clean - built for engineers who hate slide tools.
